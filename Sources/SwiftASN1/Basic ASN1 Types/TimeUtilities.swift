...
enum TimeUtilities {
    @inlinable
    static func generalizedTimeFromBytes(_ bytes: ArraySlice<UInt8>) throws(ASN1MetaError) -> GeneralizedTime {
        var bytes = bytes
    ...
    @inlinable
    static func utcTimeFromBytes(_ bytes: ArraySlice<UInt8>) throws(ASN1MetaError) -> UTCTime {
        var bytes = bytes
...
extension ArraySlice where Element == UInt8 {
    ...
    @inlinable
    mutating func _readRawFractionalSeconds() throws(ASN1MetaError) -> ArraySlice<UInt8> {
    ...
    @inlinable
    mutating func append(fractionalSeconds: Double) throws(ASN1MetaError) {
...
extension Double {
    @inlinable
    init(fromRawFractionalSeconds rawFractionalSeconds: ArraySlice<UInt8>) throws(ASN1MetaError) {

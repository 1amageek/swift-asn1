...
extension ASN1 {
    ...
    struct ParseResult: Sendable {
        ...
        @inlinable
        static func parse(_ data: ArraySlice<UInt8>, encoding rules: EncodingRules) throws(ASN1MetaError) -> ParseResult {
            var data = data
...
extension ArraySlice where Element == UInt8 {
    ...
    @inlinable
    mutating func _readASN1Length(_ minimalEncoding: Bool) throws(ASN1MetaError) -> ASN1Length? {
...
extension FixedWidthInteger {
    @inlinable
    internal init<Bytes: Collection>(bigEndianBytes bytes: Bytes) throws(ASN1MetaError) where Bytes.Element == UInt8 {

...
extension ASN1IntegerRepresentable where Self: FixedWidthInteger {
    @inlinable
    public init(derIntegerBytes bytes: ArraySlice<UInt8>) throws(ASN1MetaError) {
    ...
    @inlinable
    public init(berIntegerBytes bytes: ArraySlice<UInt8>) throws(ASN1MetaError) {

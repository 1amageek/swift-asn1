...
public protocol PEMSerializable: DERSerializable {
    ...
    func serializeAsPEM(discriminator: String) throws(ASN1MetaError) -> PEMDocument
}
...
public protocol PEMParseable: DERParseable {
    ...
    init(pemDocument: PEMDocument) throws(ASN1MetaError)
}
...
extension PEMParseable {
    ...
    @inlinable
    public init(pemEncoded pemString: String) throws(ASN1MetaError) {
    ...
    @inlinable
    public init(pemDocument: PEMDocument) throws(ASN1MetaError) {
...
extension PEMSerializable {
    ...
    @inlinable
    public func serializeAsPEM(discriminator: String) throws(ASN1MetaError) -> PEMDocument {
    ...
    @inlinable
    public func serializeAsPEM() throws(ASN1MetaError) -> PEMDocument {
...
public struct PEMDocument: Hashable, Sendable {
    ...
    public init(pemString: String) throws(ASN1MetaError) {
...
extension PEMDocument {
    ...
    public static func parseMultiple(pemString: String) throws(ASN1MetaError) -> [PEMDocument] {
        var pemString = pemString.utf8[...]
...
struct LazyPEMDocument {
    ...
    func decode() throws(ASN1MetaError) -> PEMDocument {
...
extension Substring.UTF8View {
    ...
    fileprivate mutating func readNextPEMDocument() throws(ASN1MetaError) -> LazyPEMDocument? {
    ...
    ///
    private func checkLineLengthsOfBase64EncodedString() throws(ASN1MetaError) {
        var message = self
